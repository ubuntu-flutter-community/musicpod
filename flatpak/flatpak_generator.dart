  ...
  static SpecJson fromJson(File jsonFile) {
    try {
      ...
      return SpecJson(
        ...
        linuxReleaseBundleDirPath: json['linuxReleaseBundleDirPath'] as String,
        ...
        flatpakCommandsAfterUnpack: (json['buildCommandsAfterUnpack'] as List?)
