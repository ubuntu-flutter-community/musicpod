...
class MockSettingsService extends _i1.Mock implements _i4.SettingsService {
  ...
  @override
  bool get useYaruTheme => (super.noSuchMethod(
        Invocation.getter(#useYaruTheme),
        returnValue: false,
      ) as bool);

  @override
  bool get useCustomThemeColor => (super.noSuchMethod(
        Invocation.getter(#useCustomThemeColor),
        returnValue: false,
      ) as bool);

  @override
  int get iconSetIndex => (super.noSuchMethod(
        Invocation.getter(#iconSetIndex),
        returnValue: 0,
      ) as int);

  @override
  int get localAudioIndex => (super.noSuchMethod(
        Invocation.getter(#localAudioIndex),
        returnValue: 0,
      ) as int);
  ...
  @override
  bool get groupAlbumsOnlyByAlbumName => (super.noSuchMethod(
        Invocation.getter(#groupAlbumsOnlyByAlbumName),
        returnValue: false,
      ) as bool);

  @override
  bool get enableLastFmScrobbling => (super.noSuchMethod(
        Invocation.getter(#enableLastFmScrobbling),
        returnValue: false,
      ) as bool);

  @override
  bool get enableListenBrainzScrobbling => (super.noSuchMethod(
  ...
  @override
  bool get useMoreAnimations => (super.noSuchMethod(
        Invocation.getter(#useMoreAnimations),
        returnValue: false,
      ) as bool);

  @override
  bool get saveWindowSize => (super.noSuchMethod(
        Invocation.getter(#saveWindowSize),
        returnValue: false,
      ) as bool);

  @override
  bool get notifyDataSafeMode => (super.noSuchMethod(
  ...
  @override
  String get forcedUpdateThreshold => (super.noSuchMethod(
  ...
  @override
  bool get showPositionDuration => (super.noSuchMethod(
  ...
  void setEnableListenBrainzScrobbling(bool? value) => super.noSuchMethod(
        Invocation.method(
          #setEnableListenBrainzScrobbling,
          [value],
        ),
        returnValueForMissingStub: null,
      );
  ...
  @override
  _i3.Future<bool> setEnableDiscordRPC(bool? value) => (super.noSuchMethod(
        Invocation.method(
          #setEnableDiscordRPC,
          [value],
        ),
  ...
  @override
  bool getBackupSaved(String? version) => (super.noSuchMethod(
        Invocation.method(
          #getBackupSaved,
          [version],
        ),
  ...
  @override
  _i3.Future<void> setBackupSaved(
    String? version,
    bool? value,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<void> setShowPositionDuration(bool? value) => (super.noSuchMethod(
        Invocation.method(
          #setShowPositionDuration,
          [value],
        ),
        returnValue: _i3.Future<void>.value(),
        returnValueForMissingStub: _i3.Future<void>.value(),
  ...
  @override
  _i3.Future<void> wipeAllSettings() => (super.noSuchMethod(
        Invocation.method(
          #wipeAllSettings,
          [],
        ),
...
class MockLibraryService extends _i1.Mock implements _i7.LibraryService {
  ...
  @override
  List<_i8.Audio> get likedAudios => (super.noSuchMethod(
        Invocation.getter(#likedAudios),
        returnValue: <_i8.Audio>[],
      ) as List<_i8.Audio>);

  @override
  int get likedAudiosLength => (super.noSuchMethod(
        Invocation.getter(#likedAudiosLength),
        returnValue: 0,
      ) as int);
  ...
  @override
  void updateExternalPlaylistID(
    String? oldName,
    String? newName,
  ) =>
      super.noSuchMethod(
        Invocation.method(
          #updateExternalPlaylistID,
          [
            oldName,
            newName,
          ],
  ...
  @override
  bool isPodcastSubscribed(String? feedUrl) => (super.noSuchMethod(
        Invocation.method(
          #isPodcastSubscribed,
          [feedUrl],
        ),
  ...
  void addFavoriteAlbum(
    String? id, {
    required dynamic Function()? onFail,
  }) =>
      super.noSuchMethod(
        Invocation.method(
          #addFavoriteAlbum,
  ...
  @override
  bool isPageInLibrary(String? pageId) => (super.noSuchMethod(
        Invocation.method(
          #isPageInLibrary,
          [pageId],
        ),
